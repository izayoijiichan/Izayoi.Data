...
namespace Izayoi.Data.Query
{
    ...
    public class Set
    {
        ...
        /// <summary>
        /// Initializes a new instance of the Set class with the specified columnName and value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the Set class with the specified columnName, value and dbType.
        /// </summary>
        /// <param name="columnName">The column name.</param>
        /// <param name="value">The value.</param>
        /// <param name="dbType">The DB type of value.</param>
        public Set(string columnName, object? value, DbType dbType)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the Set class with the specified columnName, value and isExpression.
        /// </summary>
        /// <param name="columnName">The column name.</param>
        /// <param name="value">The value.</param>
        /// <param name="isExpression">Whether value is expression.</param>
        public Set(string columnName, object? value, bool isExpression)
        {
            _columnName = columnName;
        ...
        public string GetColumnName(QuotationMarkSet quotationMarks)
        {
            if (quotationMarks.IsAvailable)
            {
                if (_columnName.Contains('.'))
                {
                    string[] strs = _columnName.Split('.');

                    return string.Join('.', strs.Select(str => quotationMarks.Enclose(str)));
                }
                else
                {
                    return quotationMarks.Enclose(_columnName);
                }
            }
            else
            {
