...
// @Class     : ComparableTimestampedObject
// ----------------------------------------------------------------------
#nullable enable
namespace Izayoi.Data.TimestampedObjects
{
    ...
    /// <summary>
    /// Generic Comparable Timestamped Object
    /// </summary>
        ...
        where TValue : IComparable<TValue>, IEquatable<TValue>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ComparableTimestampedObject class.
        /// </summary>
        public ComparableTimestampedObject()
        {
            timestamp = 0;
        ...
        /// <summary>
        /// Initializes a new instance of the ComparableTimestampedObject class with the specified timestamp and value.
        /// </summary>
        /// <param name="timestamp">A Unix timestamp milliseconds.</param>
        /// <param name="value">A value.</param>
        public ComparableTimestampedObject(in long timestamp, in TValue? value)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the ComparableTimestampedObject class with the specified value.
        /// </summary>
        /// <param name="value">A value.</param>
        public ComparableTimestampedObject(in TValue? value)
        {
        ...
        public int CompareTo(ComparableTimestampedObject<TValue>? other)
        {
            if (other is null)
            {
        ...
        public int CompareTo(IComparableTimestampedObject<TValue>? other)
        {
            if (other is null)
            {
                return 1;  // this (not null) > other (null)
        ...
        public int CompareTo(object? other)
        {
            ...
            if (other is ComparableTimestampedObject<TValue> typedOther)
            {
                return CompareTo(typedOther);
            }

            if (other is IComparableTimestampedObject<TValue> iTypedOther)
            {
        ...
        public bool Equals(ComparableTimestampedObject<TValue>? other)
        {
            if (other is null)
            {
                return false;
        ...
        public bool Equals(IComparableTimestampedObject<TValue>? other)
        {
            if (other is null)
            {
                return false;
        ...
        public static bool operator ==(
            in ComparableTimestampedObject<TValue> left,
            in ComparableTimestampedObject<TValue> right)
        {
