...
// @Struct    : UncomparableStructPack<TValue1, TValue2, TValue3, TValue4>
// ----------------------------------------------------------------------
#nullable enable
namespace Izayoi.Data.Packs
{
        ...
        where TValue4 : struct
    {
        ...
        public bool Equals(UncomparableStructPack<TValue1, TValue2, TValue3, TValue4> other)
        {
        ...
        public override bool Equals(object? other)
        {
            ...
            if (other is UncomparableStructPack<TValue1, TValue2, TValue3, TValue4> typedOther)
            {
        ...
        public static bool operator ==(
            in UncomparableStructPack<TValue1, TValue2, TValue3, TValue4> left,
            in UncomparableStructPack<TValue1, TValue2, TValue3, TValue4> right)
        {
