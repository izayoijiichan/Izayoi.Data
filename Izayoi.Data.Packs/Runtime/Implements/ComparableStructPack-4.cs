...
// @Struct    : ComparableStructPack<TValue1, TValue2, TValue3, TValue4>
// ----------------------------------------------------------------------
#nullable enable
namespace Izayoi.Data.Packs
{
        ...
        where TValue4 : struct, IComparable<TValue4>, IEquatable<TValue4>
    {
        ...
        public int CompareTo(ComparableStructPack<TValue1, TValue2, TValue3, TValue4> other)
        {
        ...
        public int CompareTo(IComparableStructPack<TValue1, TValue2, TValue3, TValue4>? other)
        {
            if (other is null)
            {
        ...
        public int CompareTo(object? other)
        {
            ...
            if (other is ComparableStructPack<TValue1, TValue2, TValue3, TValue4> typedOther)
            {
                return CompareTo(typedOther);
            }

            if (other is IComparableStructPack<TValue1, TValue2, TValue3, TValue4> iTypedOther)
            {
        ...
        public bool Equals(ComparableStructPack<TValue1, TValue2, TValue3, TValue4> other)
        {
        ...
        public bool Equals(IComparableStructPack<TValue1, TValue2, TValue3, TValue4>? other)
        {
            if (other is null)
            {
                return false;
        ...
        public static bool operator ==(
            in ComparableStructPack<TValue1, TValue2, TValue3, TValue4> left,
            in ComparableStructPack<TValue1, TValue2, TValue3, TValue4> right)
        {
